...
/turf/stalker/floor/dusty
	name = "floor"
	icon = 'icons/stalker/floor.dmi'
	icon_state = "dusty"

/turf/stalker/floor/oldplating
	name = "floor"
	icon = 'icons/stalker/floor.dmi'
	icon_state = "old_plating"

/turf/stalker/floor/flooring1
	name = "floor"
	icon = 'icons/stalker/floor.dmi'
	icon_state = "flooring1"

/turf/stalker/floor/flooring2
	name = "floor"
	icon = 'icons/stalker/floor.dmi'
	icon_state = "flooring2"

/turf/stalker/floor/flooring3
	name = "floor"
	icon = 'icons/stalker/floor.dmi'
	icon_state = "flooring3"

/turf/stalker/floor/flooring4
	name = "floor"
	icon = 'icons/stalker/floor.dmi'
	icon_state = "flooring4"

/turf/stalker/floor/flooring4/dark
	name = "floor"
	icon = 'icons/stalker/floor.dmi'
	icon_state = "flooring4_dark"
...
/turf/stalker/floor/plasteel/plitochkared
	icon_state = "plitkared1"

/turf/stalker/floor/plasteel/plitochkared/New()
	icon_state = "plitkared[rand(1, 7)]"
