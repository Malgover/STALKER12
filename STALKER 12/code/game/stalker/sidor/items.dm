...
/sidoritem/fort12
	...
	cost = 5000
	words = list("����" = 5, "����" = 5, "���� 12" = 5, "���� 12" = 5, "����12" = 5, "����12" = 5, "12 ��2" = 5, "12 ��2" = 5, "12��2" = 5, "12��2" = 10)

/sidoritem/pb1s
	name = "PB1s"
	itemtype = /obj/item/weapon/gun/projectile/automatic/pistol/pb1s
	cost = 4000
	words = list("��1�" = 5, "��1�" = 5, "��1�" = 5, "��1�" = 5, "��1�" = 5, "��1�" = 10)
...
/sidoritem/respirator
	name = "respirator"
	itemtype = /obj/item/clothing/mask/gas/stalker/respirator
	cost = 500
	words = list("����������" = 5, "����������" = 5)
...
/sidoritem/ecolog
	...
	cost = 85000
	words = list("�������" = 5, "�������" = 5, "�������" = 5, "�������" = 5, "���" = 5, "���-99" = 5, "99" = 5, "������" = 5, "������" = 10)

/sidoritem/ecologm
	name = "SPP-99M"
	itemtype = /obj/item/clothing/suit/hooded/sealed/ecologm
	cost = 100000
	words = list("�������" = 5, "�������" = 5, "���������" = 5, "���������" = 5, "�����������" = 5, "�����������" = 5, "���" = 5, "���-99�" = 15, "99�" = 5, "����������" = 5, "����������" = 5, "������" = 5, "������" = 10)
...
/sidoritem/psz9md
	...
	cost = 80000
	words = list("���" = 5, "9��" = 5, "���9��" = 5, "���" = 5, "9��" = 5, "���9��" = 5, "����" = 5, "����" = 5, "�����" = 5, "�����" = 5)

//�����������

/sidoritem/firstaid/stalker
	name = "Firstaid"
	itemtype = /obj/item/weapon/storage/firstaid/stalker/civillian
	cost = 500
	words = list("�������" = 5, "�������" = 5, "�������" = 5, "�������" = 5)

/sidoritem/firstaid/army
	name = "Army firstaid"
	itemtype = /obj/item/weapon/storage/firstaid/stalker/military
	cost = 1000
	words = list("�������" = 5, "�������" = 5, "���������" = 5, "���������" = 5, "�������" = 5, "�������" = 5, "������&#255;" = 5, "������&#255;" = 5, "�������" = 5, "�������" = 5)

/sidoritem/firstaid/science
	name = "Science firstaid"
	itemtype = /obj/item/weapon/storage/firstaid/stalker/scientific
	cost = 2000
