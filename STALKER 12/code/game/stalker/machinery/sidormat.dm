...
var/list/global_sidormat_list = list(
	...
	"Ammo Boxes" = list(
		...
		new /datum/data/stalker_equipment("7.62x39mm Ammo Pouch",			"Пачка патронов 7.62x39мм",							/obj/item/ammo_box/magazine/stalker/sks,	1000,	ROOKIE),
	...
	"Suits" = list(
		...
		new /datum/data/stalker_equipment("Berill-5M",					"Берилл-5М",				/obj/item/clothing/suit/berill,								50000,		EXPERIENCED,faction = "Military"),
	...
	"Masks and Helmets" = list(
		...
		new /datum/data/stalker_equipment("Mercenary Gas Mask",			"Противогаз наёмника",			/obj/item/clothing/mask/gas/stalker/mercenary,					7500,	ROOKIE,	faction = "Mercenaries"),
